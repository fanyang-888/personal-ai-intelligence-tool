...
export const zh: Translations = {
  ...
  home: {
    ...
    emptyFeaturedDesc: "流水线运行后，今日头条将显示在此处。",
    emptyDraftTitle: "草稿即将就绪",
    emptyDraftDesc: "今日草稿将在流水线完成后生成。",
    topClusters: "热门故事集群",
  ...
  archive: {
    title: "资料库",
    description:
      "检索 Sipply 整合过的全部故事 — 按分类或关键词筛选。",
    searchPlaceholder: "标题或摘要中的关键词…",
    searchLabel: "搜索",
    results: "结果",
    emptyCatalog: "目录中暂无故事",
    noResultsTitle: "无匹配结果",
    noResultsMessage: "请尝试其他关键词或分类。",
    filterCategory: "分类",
    allCategories: "全部分类",
    loading: "正在加载资料库…",
    suggestThemesLead: "试试按分类浏览：",
    sortBestMatch: "最相关",
    sortNewest: "最新",
    loadingMore: "加载中…",
    loadMore: (remaining) => `加载更多（还剩 ${remaining} 条）`,
    resultCountStories: (n) => `${n.toLocaleString()} 个故事`,
    freshnessMinutes: (m) => `${m} 分钟前更新`,
    freshnessHours: (h) => `${h} 小时前更新`,
    freshnessDays: (d) => `${d} 天前更新`,
    sourceCountLabel: (n) => n > 0 ? `${n} 个来源` : "—",
  },
  channels: {
    email: "邮件",
    chat: "聊天",
  ...
  cluster: {
    ...
    openDraft: "打开草稿",
    bilingualAssistTrustNote: "以下内容为 AI 自动翻译，英文原文附后供参考。",
