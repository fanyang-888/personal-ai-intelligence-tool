...
function toClusterRow(c: { id: string; title: string; summary: string | null; tags: string[]; theme: string; storyStatus: string; clusterScore: number | null; lastSeenAt: string | null; sourceCount: number }): ArchiveClusterRow {
  return {
    kind: "cluster",
    id: c.id,
    title: c.title,
